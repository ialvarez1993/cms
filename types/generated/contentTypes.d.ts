...
export interface ApiCabeceraMenuInteriorCategoriaDosCabeceraMenuInteriorCategoriaDos
  extends Struct.CollectionTypeSchema {
  collectionName: 'cabecera_menu_interior_categorias_dos';
  info: {
    description: '';
    displayName: 'Cabecera - Menu Interior Categor\u00EDas Dos';
    pluralName: 'cabecera-menu-interior-categorias-dos';
    singularName: 'cabecera-menu-interior-categoria-dos';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cabecera-menu-interior-categoria-dos.cabecera-menu-interior-categoria-dos'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCabeceraTextoYLinkCabeceraTextoYLink
  extends Struct.SingleTypeSchema {
  collectionName: 'cabecera_textos_y_links';
  info: {
    description: '';
    displayName: 'Cabecera - Texto y Links';
    pluralName: 'cabecera-textos-y-links';
    singularName: 'cabecera-texto-y-link';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    internalCategories: Schema.Attribute.Component<
      'shared.internal-category',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    internalPages: Schema.Attribute.Component<'shared.internal-page', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cabecera-texto-y-link.cabecera-texto-y-link'
    >;
    logocabecera: Schema.Attribute.Media<
...
export interface ApiInicioMenuCategoriasDeBusquedaInicioMenuCategoriasDeBusqueda
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    linkCategory: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::cabecera-menu-interior-categoria-dos.cabecera-menu-interior-categoria-dos': ApiCabeceraMenuInteriorCategoriaDosCabeceraMenuInteriorCategoriaDos;
      'api::cabecera-texto-y-link.cabecera-texto-y-link': ApiCabeceraTextoYLinkCabeceraTextoYLink;
